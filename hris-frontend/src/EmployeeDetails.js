...
function EmployeeDetail() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3001/employees`)
      .then((res) => {
        ...
        setFormData(found);
        if (found?.photo_url) {
          setPreviewPhoto(`http://localhost:3001${found.photo_url}`);
        }
      })
  ...
  const handlePhotoChange = (e) => {
    ...
    axios.post(`http://localhost:3001/employees/${id}/photo`, photoData)
      .then(() => {
      ...
      <div className="flex-1 p-10 text-gray-800">
        ...
        <div className="space-y-6">
          <Section title="Personal Details" data={[
            ...
            { label: "Contact Number", value: employee.contact_number },   // 👈 ADD THIS
